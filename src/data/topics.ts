...
export const topics: Topic[] = [
  ...
  { id: 't-06', title: 'NR-10', category: 'cat-nr', description: 'Nova NR-10 e sua integração com GRO, NR-1 e demais normas do sistema.', day: 1 },
  ...
  { id: 't-13', title: 'GRO — Gerenciamento de Riscos Ocupacionais', category: 'cat-health', description: 'Integração do GRO com normas específicas e gestão sistêmica de riscos.', day: 'both' },
